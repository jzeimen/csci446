...
a = Author.create(name: "Brighton Early");
...
a = Author.create(name: "Max Power");
...
a = Author.create(name: "Justin Time");
...
a = Author.create(name: "Jay Walker");
...
a = Author.create(name: "Hazle Nutt");
...
a = Author.create(name: "Ferris Wheeler");
...
a = Author.create(name: "Ali Gator");
...
a = Author.create(name: "Bill Ding");
...
a = Author.create(name: "Curt N. Rodd");
...
a = Author.create(name: "Hugo First");
...
a = Author.create(name: "Jose Frayed");
...
a = Author.create(name: "Candice B. DePlace");
